...
if ($_POST['mess']) {
    ...
    $q = "select * FROM user WHERE username=\"" . $_POST['mess'] . "\";";
    $r = @mysqli_query($bd, $q);
    ...
    <div class="panel panel-primary" style="background-color: #696969;">
        ...
        <div class="panel-body">
            ...
            $quu = "SELECT question_title, views, question_description, time_created  FROM question
                        ...
                        NATURAL JOIN user WHERE username=\"" . $_POST['mess'] . "\";";
            ...
            if ($r) {
                ...
                echo '<div class="alert alert-danger" role="alert"><p class="error">Could not execute query</p></div>';
                echo '<div class="alert alert-danger" role="alert"><p>' . mysqli_error($bd) . '<br><br>Query: ' . $quu . '</p></div>';
            }
...
<div class="row">
    ...
    <div class="panel panel-primary" style="background-color: #696969;">
        ...
        <div class="panel-body">
            ...
            $qK = "SELECT answer, up_vote, created FROM answer
                        NATURAL JOIN user_answer
                        NATURAL JOIN user WHERE username=\"" . $_POST['mess'] . "\";";
            $r = @mysqli_query($bd, $qK);
            ...
            if ($r) {
                ...
                echo '<div class="alert alert-danger" role="alert">' . mysqli_error($bd) . '<br><br>Query: ' . $qK . '</div>';
            }
